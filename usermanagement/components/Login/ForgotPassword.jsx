...
import { sendOtp, otpVerification,resetPassword } from "../../APIs/Index";
...
function ForgotPassword() {
  ...
  const validate = (e) => {
   if(!newPassword){
    ...
    } else if (phone.length < 10 || phone.length > 10 || phone == phoneRegExp) {
  ...
  return (
    ...
    <OtpConstant open={open} setOpen={setOpen} phone={phone} setNewPassword={setNewPassword} newPassword={newPassword}/>
    </div>
  );
}
